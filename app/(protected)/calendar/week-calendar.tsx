...
import { getDayStateLabel } from "@/lib/training/semantics";
import { acceptAdaptationAction, clearSkippedAction, confirmSkippedAction, dismissAdaptationAction, markActivityExtraAction, markSkippedAction, moveSessionAction } from "@/app/(protected)/calendar/actions";
import { hasConfirmedSkipTag } from "@/lib/plans/skip-notes";
import type { CalendarSession, SessionStatus, WeekDay } from "./components/week-calendar-types";
import {
  AssignUploadModal,
  DetailsModal,
  MoveModal,
  QuickAddModal
} from "./components/week-calendar-modals";
