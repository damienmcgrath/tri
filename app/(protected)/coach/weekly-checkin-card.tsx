  ...
  return (
    <div className="rounded-[22px] border border-[hsl(var(--border))] bg-[linear-gradient(180deg,hsl(var(--surface-subtle)),hsl(var(--surface)))] p-4">
      <div className="flex flex-wrap items-start justify-between gap-3">
        <div>
          <p className="text-sm font-medium text-[hsl(var(--text-primary))]">{metric.label}</p>
          ...
          <label
            ...
            className={`cursor-pointer rounded-full border px-3.5 py-2 text-sm font-medium transition ${
              value === choice.value
                ...
                : "border-[hsl(var(--border))] bg-[hsl(var(--surface))] text-muted hover:border-[hsl(var(--accent)/0.35)] hover:bg-[hsl(var(--surface-subtle))] hover:text-[hsl(var(--text-primary))]"
            }`}
          >
            <input
              type="radio"
              ...
              <div className="flex flex-wrap items-start justify-between gap-3">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <button
                    ...
                    className="inline-flex h-9 w-9 items-center justify-center rounded-full border border-[hsl(var(--border))] text-lg text-muted transition hover:text-[hsl(var(--text-primary))]"
            ...
            <div className="space-y-5 p-5">
              ...
              <div className="rounded-[22px] border border-[hsl(var(--border))] bg-[hsl(var(--surface-subtle))] p-4">
                <label className="block space-y-2 text-sm">
                  <span className="text-sm font-medium text-[hsl(var(--text-primary))]">Quick note</span>
            ...
            <div className="flex flex-wrap items-center justify-between gap-3 border-t border-[hsl(var(--border))] bg-[hsl(var(--surface-subtle))] p-5">
              ...
              <div className="flex items-center gap-3">
                ...
                <button
                  type="button"
                  onClick={() => setIsModalOpen(false)}
                  className="rounded-full border border-[hsl(var(--border))] px-4 py-2 text-sm text-muted transition hover:text-[hsl(var(--text-primary))]"
                >
                  Cancel
                </button>
                <button
