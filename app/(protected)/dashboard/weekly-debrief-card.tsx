  ...
  return (
    <article className="surface p-4">
      <div className="flex flex-wrap items-start justify-between gap-3">
        ...
        <span className={`rounded-full border px-3 py-1 text-xs ${snapshot.stale ? "border-[hsl(var(--warning)/0.38)] bg-[hsl(var(--warning)/0.12)] text-[hsl(var(--text-primary))]" : "border-[hsl(var(--border))] text-tertiary"}`}>
