...
const STATUS_ICONS: Record<VerdictStatus, React.ReactNode> = {
  achieved: (
...
function DeviationIcon({ severity }: { severity: Deviation["severity"] }) {
  if (severity === "significant") {
    return (
      <svg width="8" height="8" viewBox="0 0 8 8" className="mt-0.5 shrink-0 text-danger" aria-hidden="true">
  ...
  if (severity === "moderate") {
    return (
      <svg width="8" height="8" viewBox="0 0 8 8" className="mt-0.5 shrink-0 text-warning" aria-hidden="true">
        <circle cx="4" cy="4" r="3" stroke="currentColor" strokeWidth="2" fill="none" />
      </svg>
    );
  }
  return (
    <svg width="8" height="8" viewBox="0 0 8 8" className="mt-0.5 shrink-0 text-muted" aria-hidden="true">
  ...
  return (
    <article className="rounded-2xl border border-[hsl(var(--border))] bg-[hsl(var(--surface-subtle))]">
      ...
      <div className="flex items-center justify-between px-5 pt-4 pb-0">
        <p className="text-[10px] uppercase tracking-[0.16em] text-tertiary">Session verdict</p>
        <button
          type="button"
      ...
      <div className="divide-y divide-[hsl(var(--border))]">
        ...
        <div className="px-5 py-4">
          ...
          >
            <div className="flex items-center gap-2">
              ...
              >
                {STATUS_ICONS[verdict.verdict_status]}
              </span>
          ...
          {/* Metric comparisons — structured table layout */}
                ...
                <table className="w-full text-xs">
                  <thead>
                    <tr className="bg-[rgba(255,255,255,0.03)]">
                      <th className="px-3 py-2 text-left font-normal text-tertiary">Metric</th>
                      <th className="px-3 py-2 text-right font-normal text-tertiary">Target</th>
                      <th className="px-3 py-2 text-right font-normal text-tertiary">Actual</th>
                    </tr>
                  </thead>
          ...
          {/* Expandable explanation — styled as pill button */}
          <button
            type="button"
            onClick={() => setShowExplanation(!showExplanation)}
            className="mt-3 rounded-full border border-[hsl(var(--border))] px-3 py-1 text-[11px] text-tertiary hover:border-[rgba(255,255,255,0.25)] hover:text-white"
          >
        ...
        <div className="px-5 py-4">
          <p className="text-[10px] uppercase tracking-[0.16em] text-tertiary">What this means for your plan</p>
