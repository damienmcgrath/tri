    ...
    <article className="surface border border-[rgba(190,255,0,0.18)] bg-[rgba(190,255,0,0.04)] p-5">
          ...
          <button
            ...
            className={`min-h-[44px] w-full rounded-lg border text-sm font-medium transition-colors ${
              selectedRpe === rpe
                ...
                : "border-[hsl(var(--border))] bg-[hsl(var(--surface-subtle))] text-[rgba(255,255,255,0.6)] hover:border-[rgba(255,255,255,0.25)] hover:text-primary"
            }`}
          >
            {rpe}
          </button>
      ...
      <div className="mt-4">
        <textarea
          ...
          rows={2}
          className="w-full rounded-lg border border-[hsl(var(--border))] bg-[hsl(var(--bg-card))] px-3 py-2 text-sm text-primary placeholder:text-tertiary focus:border-[rgba(190,255,0,0.4)] focus:outline-none"
        />
